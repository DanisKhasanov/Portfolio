...
export const Button = ({
  ...
  const baseClasses =
    "font-medium rounded-lg transition-all duration-300 transform hover:scale-105 focus:outline-none ";
  ...
  const variantClasses = {
    ...
    outline: `border-2 ${colors.border} ${colors.text} hover:bg-gradient-to-r ${
      colors.secondary
    } hover:text-white ${colors.ring}`,
